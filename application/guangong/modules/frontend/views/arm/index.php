	...
	<div class="swiper-wrapper">
		...
		<div class="swiper-slide" id="arm-2">
			...
			<div class="layer steps">
				<a href="<?php echo $this->url('arm/job')?>"><img src="<?php echo $this->appAssets('images/arm/s5.png')?>"></a>
				<a href="<?php echo $this->url('arm/info')?>"><img src="<?php echo $this->appAssets('images/arm/s4.png')?>"></a>
				<a href="<?php echo $this->url('arm/set-hour')?>"><img src="<?php echo $this->appAssets('images/arm/s3.png')?>"></a>
				<a href="<?php echo $this->url('arm/set-arm')?>"><img src="<?php echo $this->appAssets('images/arm/s2.png')?>"></a>
				<a href="<?php echo $this->url('arm/set-defence')?>"><img src="<?php echo $this->appAssets('images/arm/s1.png')?>"></a>
			</div>
