...
<div class="col-2-1">
	<div class="col-left">
		...
		<div class="form-field">
			...
			<?php echo F::form()->select('role', Html::getSelectOptions($roles, 'id', 'title'), array('class'=>'w300'))?>
		</div>
		<div class="form-field">
			<label class="title">手机</label>
			<?php echo F::form()->inputText('cellphone', array('class'=>'w300'))?>
		</div>
		<div class="form-field">
			<label class="title">邮箱</label>
			<?php echo F::form()->inputText('email', array('class'=>'w300'))?>
		</div>
		<div class="form-field">
