<div class="swiper-slide" id="recruit-3">
    ...
    <div class="layer steps">
        ...
        <a href="#6" class="swiper-to" data-slide="6"><img src="<?php echo $this->appAssets('images/recruit/s2.png')?>"></a>
        <a href="#3" class="swiper-to" data-slide="3"><img src="<?php echo $this->appAssets('images/recruit/s1.png')?>"></a>
    </div>
</div>