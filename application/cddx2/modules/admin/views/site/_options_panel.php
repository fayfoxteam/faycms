    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="form-field">
                ...
                <?php echo HtmlHelper::inputText('site:copyright_en', OptionService::get('site:copyright_en'), array(
                    'class'=>'form-control',
                ))?>
            </div>
            <div class="form-field">
                <label class="title">邮编</label>
                <?php echo HtmlHelper::inputText('site:postcode', OptionService::get('site:postcode'), array(
                    'class'=>'form-control',
                ))?>
            </div>
            <div class="form-field">
                <label class="title">主办</label>
                <?php echo HtmlHelper::inputText('site:oganizer', OptionService::get('site:oganizer'), array(
                    'class'=>'form-control',
                ))?>
            </div>
            <div class="form-field">
