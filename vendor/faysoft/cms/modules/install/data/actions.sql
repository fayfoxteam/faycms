...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1601', '试题库', 'cms/admin/exam-question/index', '116', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1602', '添加试题', 'cms/admin/exam-question/create', '116', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1603', '编辑试题', 'cms/admin/exam-question/edit', '116', '0', '1601');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1604', '删除试题', 'cms/admin/exam-question/delete', '116', '0', '1601');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1605', '分类列表', 'cms/admin/exam-question/cat', '116', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1606', '添加分类', 'cms/admin/exam-question/cat-create', '116', '0', '1605');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1607', '删除分类', 'cms/admin/exam-question/cat-remove', '116', '0', '1605');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1608', '编辑分类', 'cms/admin/exam-question/cat-edit', '116', '0', '1605');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1701', '列表', 'cms/admin/exam-paper/index', '117', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1702', '组卷', 'cms/admin/exam-paper/create', '117', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1703', '编辑', 'cms/admin/exam-paper/edit', '117', '0', '1701');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1704', '删除', 'cms/admin/exam-paper/delete', '117', '0', '1701');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1705', '阅卷（列表）', 'cms/admin/exam-exam/index', '117', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1706', '阅卷（详细）', 'cms/admin/exam-exam/item', '117', '0', '1705');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1707', '阅卷（评分）', 'cms/admin/exam-exam/set-score', '117', '0', '1706');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1708', '阅卷（永久删除）', 'cms/admin/exam-exam/remove', '117', '0', '1705');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1709', '分类列表', 'cms/admin/exam-paper/cat', '117', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1710', '添加分类', 'cms/admin/exam-paper/cat-create', '117', '0', '1709');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1711', '编辑分类', 'cms/admin/exam-paper/cat-edit', '117', '0', '1709');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1712', '删除分类', 'cms/admin/exam-paper/cat-remove', '117', '0', '1709');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1801', '模版列表', 'cms/admin/template/index', '118', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1802', '添加模版', 'cms/admin/template/create', '118', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1803', '添加模版', 'cms/admin/template/edit', '118', '0', '1801');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1804', '删除模版', 'cms/admin/template/delete', '118', '0', '1801');
