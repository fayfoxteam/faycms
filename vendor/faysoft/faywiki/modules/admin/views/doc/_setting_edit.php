...
<?php echo F::form('setting')->open(array('cms/admin/system/setting'))?>
    ...
    <div class="form-field">
        ...
        <p class="fc-grey">注意：该设置仅在创建文档时有效，编辑文档时强制为文档创建时所使用的编辑器进行编辑</p>
        <?php
            echo F::form('setting')->inputRadio('editor', PostsTable::CONTENT_TYPE_VISUAL_EDITOR, array(
            ...
            echo F::form('setting')->inputRadio('editor', PostsTable::CONTENT_TYPE_MARKDOWN, array(
            ...
            echo F::form('setting')->inputRadio('editor', PostsTable::CONTENT_TYPE_TEXTAREA, array(
