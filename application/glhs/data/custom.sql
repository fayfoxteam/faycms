...
INSERT INTO `{{$prefix}}widgets` (`id`, `alias`, `options`, `widget_name`, `description`) VALUES ('4', 'news', '{\"title\":\"\",\"top\":1008,\"subclassification\":1,\"number\":6,\"show_empty\":1,\"thumbnail\":0,\"order\":\"hand\",\"last_view_time\":0,\"date_format\":\"Y-m-d\",\"uri\":\"news-{$id}\",\"other_uri\":\"news-{$id}\",\"template\":\"frontend\\/widget\\/news\"}', 'fay/category_post', '资讯');
INSERT INTO `{{$prefix}}widgets` (`id`, `alias`, `options`, `widget_name`, `description`) VALUES ('5', 'works', '{\"title\":\"\",\"top\":1001,\"subclassification\":1,\"number\":6,\"show_empty\":0,\"thumbnail\":0,\"order\":\"hand\",\"last_view_time\":0,\"date_format\":\"pretty\",\"uri\":\"works-{$id}\",\"other_uri\":\"works-{$id}\",\"template\":\"frontend\\/widget\\/works\"}', 'fay/category_post', '作品展');
INSERT INTO `{{$prefix}}widgets` (`id`, `alias`, `options`, `widget_name`, `description`) VALUES ('6', 'abstract', '{\"title\":\"\",\"top\":1000,\"subclassification\":1,\"number\":4,\"show_empty\":0,\"thumbnail\":1,\"order\":\"hand\",\"last_view_time\":0,\"date_format\":\"pretty\",\"uri\":\"tercher\",\"other_uri\":\"tercher\",\"template\":\"frontend\\/widget\\/abstract\"}', 'fay/category_post', '我们的团队');
