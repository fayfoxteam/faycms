...
class NotificationController extends AdminController{
    ...
    public function setRead(){
        ...
        Response::notify(Response::NOTIFY_SUCCESS, '一条信息被标记为'.($read ? '已读' : '未读'));
    }
    ...
    public function batch(){
        ...
        switch($action){
            case 'set-read':
                ...
                Response::notify(Response::NOTIFY_SUCCESS, $affected_rows.'条消息被标记为已读');
            break;
            case 'set-unread':
                $affected_rows = UsersNotificationsTable::model()->update(array(
                    'read'=>0,
                ...
                Response::notify(Response::NOTIFY_SUCCESS, $affected_rows.'条消息被标记为未读');
            break;
            case 'delete':
                $affected_rows = UsersNotificationsTable::model()->update(array(
                    'delete_time'=>\F::app()->current_time,
                ...
                Response::notify(Response::NOTIFY_SUCCESS, $affected_rows.'条消息被删除');
            break;
        }
    }
}