...
$this->appendCss($this->appAssets('css/travel.css'));
?>
<div class="container containerbg">
    ...
    <div class="nav-switch mt10">
        <div class="nav-category">
            <h4>所在地区：</h4>
            <ul>
                <li><?php echo HtmlHelper::link('全部', FriendlyLink::getTravelListLink(array(
                    'area'=>0,
                    'cat'=>$cat_id,
                    'month'=>$month_id
                )), array(
                ...
                <?php foreach($areas as $a){?>
                    <li><?php echo HtmlHelper::link($a['title'], FriendlyLink::getTravelListLink(array(
                        'area'=>$a['id'],
                        'cat'=>$cat_id,
                        'month'=>$month_id
                    )), array(
        ...
        <div class="nav-category">
            ...
            <ul>
                ...
                <?php foreach($cats as $c){?>
                    <li><?php echo HtmlHelper::link($c['title'], FriendlyLink::getTravelListLink(array(
                        'area'=>$area_id,
                        'cat'=>$c['id'],
                        'month'=>$month_id
                    )), array(
        ...
        <div class="nav-category">
            ...
            <ul>
                ...
                <?php foreach($monthes as $m){?>
                    <li><?php echo HtmlHelper::link($m['title'], FriendlyLink::getTravelListLink(array(
                        'area'=>$area_id,
                        'cat'=>$cat_id,
                        'month'=>$m['id']
                    )), array(
