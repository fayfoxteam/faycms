        ...
        <li class="leaf-container <?php if(!$k)echo 'first';?>">
            <div class="leaf">
                <span class="fr options">
                    ...
                    <?php if(F::app()->checkPermission('fayexam/admin/paper/cat-create')){
                    ...
                    if(F::app()->checkPermission('fayexam/admin/paper/cat-edit')){
                        echo HtmlHelper::link('编辑', '#edit-cat-dialog', array(
                            'class'=>'edit-cat-link',
                            'data-id'=>$c['id'],
                        ));
                    }
                    if(F::app()->checkPermission('fayexam/admin/paper/cat-remove')){
