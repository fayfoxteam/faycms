...
INSERT INTO `{{$prefix}}widgets` (`alias`, `options`, `widget_name`, `description`) VALUES ('recent_posts', '{\"subclassification\":1,\"top\":1,\"title\":\"\\u8fd1\\u671f\\u6587\\u7ae0\",\"number\":5,\"uri\":\"post\\/{$id}\",\"template\":\"frontend\\/widget\\/recent_posts\",\"date_format\":\"\",\"thumbnail\":0,\"order\":\"publish_time\"}', 'fay/category_post', '最新发布');
