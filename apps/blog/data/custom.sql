...
-- 两个widget
INSERT INTO `{{$prefix}}widgets` (`alias`, `config`, `widget_name`, `description`) VALUES ('categories', '{\"hierarchical\":0,\"top\":1000,\"title\":\"\\u5206\\u7c7b\",\"uri\":\"cat\\/{$id}\",\"template\":\"frontend\\/widget\\/categories\"}', 'cms/categories', '文章分类列表');
INSERT INTO `{{$prefix}}widgets` (`alias`, `config`, `widget_name`, `description`) VALUES ('recent_posts', '{\"subclassification\":1,\"top\":1,\"title\":\"\\u8fd1\\u671f\\u6587\\u7ae0\",\"number\":5,\"uri\":\"post\\/{$id}\",\"template\":\"frontend\\/widget\\/recent_posts\",\"date_format\":\"\",\"thumbnail\":0,\"order\":\"publish_time\"}', 'cms/category_posts', '最新发布');
