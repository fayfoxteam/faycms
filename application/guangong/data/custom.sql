...
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`) VALUES ('6', 'bubing-text', '.png', '70018', 'image/png', './apps/guangong/images/arm/', '步兵描述', '1', '226', '304', '{{$time}}', '10000');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`) VALUES ('7', 'chebing-text', '.png', '74441', 'image/png', './apps/guangong/images/arm/', '车兵描述', '1', '226', '330', '{{$time}}', '10000');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`) VALUES ('8', 'nubing-text', '.png', '69395', 'image/png', './apps/guangong/images/arm/', '弩兵描述', '1', '226', '305', '{{$time}}', '10000');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`) VALUES ('9', 'qibing-text', '.png', '65338', 'image/png', './apps/guangong/images/arm/', '骑兵描述', '1', '226', '306', '{{$time}}', '10000');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`) VALUES ('10', 'shuijun-text', '.png', '98869', 'image/png', './apps/guangong/images/arm/', '水军描述', '1', '227', '353', '{{$time}}', '10000');
