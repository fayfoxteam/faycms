...
INSERT INTO `{{$prefix}}options` (`option_name`, `option_value`, `description`, `create_time`, `last_modified_time`, `is_system`) VALUES ('system:post_role_cats', '0', '是否启用角色文章分类权限控制', '{{$time}}', '{{$time}}', '1');
...
INSERT INTO `{{$prefix}}options` (`option_name`, `option_value`, `description`, `create_time`, `last_modified_time`, `is_system`) VALUES ('system:user_nickname_required', '1', '用户昵称必填', '{{$time}}', '{{$time}}', '1');
INSERT INTO `{{$prefix}}options` (`option_name`, `option_value`, `description`, `create_time`, `last_modified_time`, `is_system`) VALUES ('system:user_nickname_unique', '1', '用户昵称唯一', '{{$time}}', '{{$time}}', '1');
