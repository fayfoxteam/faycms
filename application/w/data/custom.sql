...
-- 基础参数
INSERT INTO `{{$prefix}}options` (`option_name`, `option_value`, `create_time`) VALUES ('site:copyright', 'Copyright © 2012-2013 fayfox.com', '{{$time}}');
...
-- widget图片
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`, `downloads`, `type`, `qiniu`) VALUES ('1', 'slide-1', '.jpg', '167501', 'image/jpeg', './apps/fruit/images/', 'slide-1.jpg', '1', '1920', '647', '{{$time}}', '10000', '0', '0', '0');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`, `downloads`, `type`, `qiniu`) VALUES ('2', 'slide-2', '.jpg', '91236', 'image/jpeg', './apps/fruit/images/', 'slide-2.jpg', '1', '1920', '647', '{{$time}}', '10000', '0', '0', '0');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`, `downloads`, `type`, `qiniu`) VALUES ('3', 'slide-3', '.jpg', '113444', 'image/jpeg', './apps/fruit/images/', 'slide-3.jpg', '1', '1920', '647', '{{$time}}', '10000', '0', '0', '0');
INSERT INTO `{{$prefix}}files` (`id`, `raw_name`, `file_ext`, `file_size`, `file_type`, `file_path`, `client_name`, `is_image`, `image_width`, `image_height`, `upload_time`, `user_id`, `downloads`, `type`, `qiniu`) VALUES ('4', 'page1-img1', '.jpg', '30040', 'image/jpeg', './apps/fruit/images/', 'page1-img1.jpg', '1', '460', '388', '{{$time}}', '10000', '0', '0', '0');