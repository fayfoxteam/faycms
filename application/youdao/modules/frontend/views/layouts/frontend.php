...
<![endif]-->
<meta content="<?php echo OptionService::get('site:seo_index_keywords')?>" name="keywords" />
<meta content="<?php echo OptionService::get('site:seo_index_description')?>" name="description" />
<!--[if lt IE 9]>
