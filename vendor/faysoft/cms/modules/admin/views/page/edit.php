            ...
            <div class="box" id="box-operation">
                ...
                <div class="box-content">
                    ...
                    <div class="misc-pub-section mt6">
                        <strong>状态</strong>
                        <?php echo F::form()->inputRadio('status', PagesTable::STATUS_PUBLISHED, array('label'=>'已发布'))?>
...
$(function(){
    ...
    common.filebrowserImageUploadUrl = system.url('cms/admin/file/img-upload', {'cat':'page'});
    common.filebrowserFlashUploadUrl = system.url('cms/admin/file/upload', {'cat':'pages'});
