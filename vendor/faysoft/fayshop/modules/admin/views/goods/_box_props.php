        ...
        if($props){
            foreach($props as $p){
                ...
                <div class="form-field">
                    ...
                    <?php if($p['type'] == ShopGoodsCatPropsTable::TYPE_CHECK){//多选?>
                    ...
                    <?php 
                    }else if($p['type'] == ShopGoodsCatPropsTable::TYPE_OPTIONAL){//单选
                    ...
                    }else if($p['type'] == ShopGoodsCatPropsTable::TYPE_INPUT){//手工录入
