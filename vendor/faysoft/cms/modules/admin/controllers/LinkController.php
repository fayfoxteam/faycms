...
class LinkController extends AdminController{
    ...
    public function create(){
        ...
        if($this->input->post() && $this->form()->check()){
            ...
            Response::notify(Response::NOTIFY_SUCCESS, '链接添加成功', array('cms/admin/link/edit', array('id'=>$link_id)));
        }
    ...
    public function edit(){
        ...
        if($this->input->post()){
            if($this->form()->check()){
                ...
                Response::notify(Response::NOTIFY_SUCCESS, '一个链接被编辑');
            }
        }
    ...
    public function remove(){
        ...
        Response::notify(Response::NOTIFY_SUCCESS, '一个友情链接被永久删除', array('cms/admin/link/index', $this->input->get()));
    }
