...
<div id="banner">
    <img src="<?php echo $this->appAssets('images/banner.jpg')?>" />
    <div class="logos" id="csa">
        <a href=""><img src="<?php echo $this->appAssets("images/14{$postfix}.png")?>" /></a>
    </div>
...
<div id="main">
    <section id="sec-1" class="box-1">
        <div class="box-1-title">
            ...
            <a href="<?php echo $this->url('about')?>" class="more">
                <img src="<?php echo $this->appAssets('images/more.png')?>" class="fixpng" />
            </a>
        </div>
        <div class="box-1-content">
            <a href="<?php echo $this->url('about')?>">
                <img src="<?php echo $this->appAssets('images/p1.jpg')?>" />
            </a>
            <p>
    ...
    <section id="sec-2" class="box-1">
        ...
        <div class="box-1-content">
            ...
            <div id="top-news">
                <img src="<?php echo $this->appAssets('images/p2.jpg')?>" class="f-left" />
                    ...
                    <li>
                        ...
                        <a href="<?php echo $this->url("post/{$n['id']}")?>" class="news-list-title" title="<?php echo HtmlHelper::encode($n['title'])?>">
                            ...
                            <span>
                                ...
                                <img src="<?php echo $this->appAssets('images/652264.png')?>" />
                                <?php }?>
                            </span>
                        </a>
                        <br class="clear" />
    ...
    <section id="sec-3" class="box-1">
        ...
        <div class="box-1-content">
            <a href="<?php echo $this->url('contact')?>">
                <img src="<?php echo $this->appAssets('images/contact.jpg')?>" id="call-me" />
            </a>
            <p id="call-me-text">
                量身定制解决方案
                <br />
