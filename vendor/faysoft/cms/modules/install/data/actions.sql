INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('101', '列表', 'admin/link/index', '101', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('102', '添加', 'admin/link/create', '101', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('103', '编辑', 'admin/link/edit', '101', '0', '1');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('104', '永久删除', 'admin/link/remove', '101', '0', '1');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('105', '分类列表', 'admin/link/cat', '101', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('106', '添加分类', 'admin/link/cat-create', '101', '0', '5');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('107', '编辑分类', 'admin/link/cat-edit', '101', '0', '5');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('108', '删除分类', 'admin/link/cat-remove', '101', '0', '5');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('208', '上传到七牛', 'admin/qiniu/put', '102', '0', '201');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('209', '从七牛移除', 'admin/qiniu/delete', '102', '0', '201');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('210', '删除', 'admin/file/remove', '102', '0', '201');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('317', '发布', 'admin/post/publish', '103', '0', '302');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('505', '回复', 'admin/contact/reply', '105', '0', '501');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1001', '列表', 'admin/post-comment/index', '110', '0', '0');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('1107', '第三方登录', 'admin/site/oauth', '111', '0', '0');
...
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9801', '重置分类表索引', 'admin/reset/category', '198', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9802', '重置菜单表索引', 'admin/reset/menu', '198', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9803', '重置分类文章数', 'admin/reset/category-post-count', '198', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9804', '重置标签文章数', 'admin/reset/tag-post-count', '198', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9805', '重置用户文章数', 'admin/reset/user-post-count', '198', '0', '0');
INSERT INTO `{{$prefix}}actions` (`id`, `title`, `router`, `cat_id`, `is_public`, `parent`) VALUES ('9901', '汇总分类管理', 'admin/category/index', '199', '0', '0');
