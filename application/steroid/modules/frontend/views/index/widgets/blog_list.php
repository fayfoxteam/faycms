        ...
        <div class="row post-list">
            ...
            <?php foreach($posts as $p){?>
                <article class="cf">
                    ...
                    <div class="post-info">
                        <h3 class="title"><a href="<?php echo $p['post']['link']?>"><?php echo \fay\helpers\HtmlHelper::encode($p['post']['title'])?></a></h3>
                        <h6 class="description"><?php echo $p['post']['format_publish_time']?> · Buy Anavar Powder,Oxandrolone Powder,Oral Steroid Powder</h6>
                        <p class="abstract"><?php echo \fay\helpers\HtmlHelper::encode($p['post']['abstract'])?></p>
                    </div>
                </article>
            <?php }?>
            </div>
