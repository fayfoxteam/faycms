...
--
-- Host: localhost
-- Generation Time: 2015-03-17 01:47:14
...
(1, 10000, 10, '添加友情链接', 1431258070, 1, 2130706433),
(2, 10000, 10, '添加友情链接', 1431258124, 2, 2130706433),
(3, 10000, 28, '创建了一个小工具实例', 1431258158, 1, 2130706433),
(4, 10000, 6, '添加分类', 1431434606, 10000, 2130706433),
(5, 10000, 6, '添加分类', 1431434620, 10001, 2130706433),
(6, 10000, 6, '添加分类', 1431434630, 10002, 2130706433),
(7, 10000, 6, '添加分类', 1431434636, 10003, 2130706433),
(8, 10000, 6, '添加分类', 1431434646, 10004, 2130706433),
(9, 10000, 6, '添加分类', 1431434655, 10005, 2130706433);
...
(301, '添加', 'admin/post/create', 103, 0, 0),
(302, '列表', 'admin/post/index', 103, 0, 0),
(303, '排序', 'admin/post/sort', 103, 0, 302),
(304, '编辑', 'admin/post/edit', 103, 0, 302),
(305, '标签', 'admin/tag/index', 103, 0, 0),
(306, '关键词', 'admin/keyword/index', 103, 0, 0),
(307, '删除', 'admin/post/delete', 103, 0, 302),
(308, '还原', 'admin/post/undelete', 103, 0, 302),
(309, '永久删除', 'admin/post/remove', 103, 0, 302),
(310, '分类列表', 'admin/post/cat', 103, 0, 0),
(311, '添加分类', 'admin/post/cat-create', 103, 0, 310),
(312, '分类属性', 'admin/post-prop/index', 103, 0, 310),
(313, '编辑分类', 'admin/post/cat-edit', 103, 0, 310),
(314, '删除分类', 'admin/post/cat-remove', 103, 0, 310),
(315, '分类排序', 'admin/post/cat-sort', 103, 0, 310),
(316, '审核', 'admin/post/review', 103, 0, 302),
(501, '列表', 'admin/contact/index', 105, 0, 0),
(502, '标记为已读', 'admin/contact/set-read', 105, 0, 501),
(503, '标记为未读', 'admin/contact/set-unread', 105, 0, 501),
(504, '永久删除', 'admin/contact/remove', 105, 0, 501),
(601, '列表', 'admin/operator/index', 106, 0, 0),
(602, '添加', 'admin/operator/create', 106, 0, 0),
(603, '编辑', 'admin/operator/edit', 106, 0, 601),
(604, '查看', 'admin/operator/item', 106, 0, 601),
(605, '设置状态', 'admin/operator/set-status', 106, 0, 604),
(701, '列表', 'admin/page/index', 107, 0, 0),
(702, '添加', 'admin/page/create', 107, 0, 0),
(703, '修改', 'admin/page/edit', 107, 0, 701),
(704, '删除', 'admin/page/delete', 107, 0, 701),
(705, '永久删除', 'admin/page/remove', 107, 0, 701),
(706, '分类列表', 'admin/page/cat', 107, 0, 0),
(707, '添加分类', 'admin/page/cat-create', 107, 0, 706),
(708, '修改分类', 'admin/page/cat-edit', 107, 0, 706),
(709, '删除分类', 'admin/page/cat-remove', 107, 0, 706),
(710, '排序', 'admin/page/sort', 107, 0, 701),
(901, '列表', 'admin/user/index', 109, 0, 0),
(902, '添加', 'admin/user/create', 109, 0, 0),
(903, '查看', 'admin/user/item', 109, 0, 901),
(904, '编辑', 'admin/user/edit', 109, 0, 901),
(905, '设置状态', 'admin/user/set-status', 109, 0, 903),
(1001, '列表', 'admin/comment/index', 110, 0, 0),
(1002, '批准', 'admin/comment/approve', 110, 0, 1001),
(1003, '驳回', 'admin/comment/unapprove', 110, 0, 1001),
(1004, '删除', 'admin/comment/delete', 110, 0, 1001),
(1005, '永久删除', 'admin/comment/remove', 110, 0, 1001),
(1101, '站点参数', 'admin/site/options', 111, 0, 0),
(1102, '小工具', 'admin/widget/instances', 111, 0, 0),
(1103, '移除小工具', 'admin/widget/remove-instance', 111, 0, 1102),
(1104, '编辑小工具', 'admin/widget/edit', 111, 0, 1102),
(1201, '列表', 'admin/role/index', 112, 0, 0),
(1202, '添加', 'admin/role/create', 112, 0, 0),
(1203, '删除', 'admin/role/delete', 112, 0, 1201),
(1204, '属性', 'admin/role-prop/index', 112, 0, 1204),
(1301, '蜘蛛爬行日志', 'admin/analyst/spiderlog', 113, 0, 0),
(1302, '访客统计', 'admin/analyst/visitor', 113, 0, 0),
(1303, '访问日志', 'admin/analyst/views', 113, 0, 0),
(1304, '页面PV量', 'admin/analyst/pv', 113, 0, 0),
(1305, '站点管理', 'admin/analyst-site/index', 113, 0, 0),
(1401, '自定义导航', 'admin/menu/index', 114, 0, 0),
(1402, '添加', 'admin/menu/create', 114, 0, 1401),
(1403, '编辑', 'admin/menu/edit', 114, 0, 1401),
(1404, '删除', 'admin/menu/remove', 114, 0, 1401),
(1501, '列表', 'admin/chat/index', 115, 0, 0),
(1502, '批准', 'admin/chat/approve', 115, 0, 1501),
(1503, '驳回', 'admin/chat/unapprove', 115, 0, 1501),
(1504, '删除', 'admin/chat/delete', 115, 0, 1501),
(1505, '回复', 'admin/chat/reply', 115, 0, 1501),
(1506, '删除会话', 'admin/chat/remove-all', 115, 0, 1501),
(1601, '试题库', 'admin/exam-question/index', 116, 0, 0),
(1602, '添加试题', 'admin/exam-question/create', 116, 0, 0),
(1603, '编辑试题', 'admin/exam-question/edit', 116, 0, 1601),
(1604, '删除试题', 'admin/exam-question/delete', 116, 0, 1601),
(1605, '分类列表', 'admin/exam-question/cat', 116, 0, 0),
(1606, '添加分类', 'admin/exam-question/cat-create', 116, 0, 1605),
(1607, '删除分类', 'admin/exam-question/cat-remove', 116, 0, 1605),
(1608, '编辑分类', 'admin/exam-question/cat-edit', 116, 0, 1605),
(1701, '列表', 'admin/exam-paper/index', 117, 0, 0),
(1702, '组卷', 'admin/exam-paper/create', 117, 0, 0),
(1703, '编辑', 'admin/exam-paper/edit', 117, 0, 1701),
(1704, '删除', 'admin/exam-paper/delete', 117, 0, 1701),
(1705, '阅卷（列表）', 'admin/exam-exam/index', 117, 0, 0),
(1706, '阅卷（详细）', 'admin/exam-exam/item', 117, 0, 1705),
(1707, '阅卷（评分）', 'admin/exam-exam/set-score', 117, 0, 1706),
(1708, '阅卷（永久删除）', 'admin/exam-exam/remove', 117, 0, 1705),
(1709, '分类列表', 'admin/exam-paper/cat', 117, 0, 0),
(1710, '添加分类', 'admin/exam-paper/cat-create', 117, 0, 1709),
(1711, '编辑分类', 'admin/exam-paper/cat-edit', 117, 0, 1709),
(1712, '删除分类', 'admin/exam-paper/cat-remove', 117, 0, 1709),
(1801, '模版列表', 'admin/template/index', 118, 0, 0),
(1802, '添加模版', 'admin/template/create', 118, 0, 0),
(1803, '添加模版', 'admin/template/edit', 118, 0, 1801),
(1804, '删除模版', 'admin/template/delete', 118, 0, 1801),
(9901, '删除模版', 'admin/category/index', 199, 0, 0),
(9902, '系统参数列表', 'admin/option/index', 199, 0, 0),
(9903, '系统日志', 'admin/log/index', 199, 0, 0),
(9904, '所有小工具', 'admin/widget/index', 199, 0, 0),
(9905, '权限分类', 'admin/action/cat', 199, 0, 0),
(9906, '所有权限', 'admin/action/index', 199, 0, 0),
(9907, '添加权限', 'admin/action/create', 199, 0, 0),
(9908, '编辑权限', 'admin/action/edit', 199, 0, 9906),
(9909, '删除权限', 'admin/action/remove', 199, 0, 9906),
(9910, '系统消息分类', 'admin/notification/cat', 199, 0, 0),
(9911, '发送系统消息', 'admin/notification/create', 199, 0, 0),
(9912, '文件管理', 'admin/file/index', 199, 0, 0),
(9913, '上传文件', 'admin/file/do-upload', 199, 0, 0),
(9914, '后台菜单', 'admin/menu/admin', 199, 0, 0);
...
(1, '2015-05-10', 0, 0, 0, 0, 0, 0, 0.00),
(2, '2015-05-10', 1, 0, 0, 0, 0, 0, 0.00),
(3, '2015-05-10', 2, 0, 0, 0, 0, 0, 0.00),
(4, '2015-05-10', 3, 0, 0, 0, 0, 0, 0.00),
(5, '2015-05-10', 4, 0, 0, 0, 0, 0, 0.00),
(6, '2015-05-10', 5, 0, 0, 0, 0, 0, 0.00),
(7, '2015-05-10', 6, 0, 0, 0, 0, 0, 0.00),
(8, '2015-05-10', 7, 0, 0, 0, 0, 0, 0.00),
(9, '2015-05-10', 8, 0, 0, 0, 0, 0, 0.00),
(10, '2015-05-10', 9, 0, 0, 0, 0, 0, 0.00),
(11, '2015-05-10', 10, 0, 0, 0, 0, 0, 0.00),
(12, '2015-05-10', 11, 0, 0, 0, 0, 0, 0.00),
(13, '2015-05-10', 12, 0, 0, 0, 0, 0, 0.00),
(14, '2015-05-10', 13, 0, 0, 0, 0, 0, 0.00),
(15, '2015-05-10', 14, 0, 0, 0, 0, 0, 0.00),
(16, '2015-05-10', 15, 0, 0, 0, 0, 0, 0.00),
(17, '2015-05-09', 0, 0, 0, 0, 0, 0, 0.00),
(18, '2015-05-09', 1, 0, 0, 0, 0, 0, 0.00),
(19, '2015-05-09', 2, 0, 0, 0, 0, 0, 0.00),
(20, '2015-05-09', 3, 0, 0, 0, 0, 0, 0.00),
(21, '2015-05-09', 4, 0, 0, 0, 0, 0, 0.00),
(22, '2015-05-09', 5, 0, 0, 0, 0, 0, 0.00),
(23, '2015-05-09', 6, 0, 0, 0, 0, 0, 0.00),
(24, '2015-05-09', 7, 0, 0, 0, 0, 0, 0.00),
(25, '2015-05-09', 8, 0, 0, 0, 0, 0, 0.00),
(26, '2015-05-09', 9, 0, 0, 0, 0, 0, 0.00),
(27, '2015-05-09', 10, 0, 0, 0, 0, 0, 0.00),
(28, '2015-05-09', 11, 0, 0, 0, 0, 0, 0.00),
(29, '2015-05-09', 12, 0, 0, 0, 0, 0, 0.00),
(30, '2015-05-09', 13, 0, 0, 0, 0, 0, 0.00),
(31, '2015-05-09', 14, 0, 0, 0, 0, 0, 0.00),
(32, '2015-05-09', 15, 0, 0, 0, 0, 0, 0.00),
(33, '2015-05-09', 16, 0, 0, 0, 0, 0, 0.00),
(34, '2015-05-09', 17, 0, 0, 0, 0, 0, 0.00),
(35, '2015-05-09', 18, 0, 0, 0, 0, 0, 0.00),
(36, '2015-05-09', 19, 0, 0, 0, 0, 0, 0.00),
(37, '2015-05-09', 20, 0, 0, 0, 0, 0, 0.00),
(38, '2015-05-09', 21, 0, 0, 0, 0, 0, 0.00),
(39, '2015-05-09', 22, 0, 0, 0, 0, 0, 0.00),
(40, '2015-05-09', 23, 0, 0, 0, 0, 0, 0.00),
(41, '2015-05-09', -1, 0, 0, 0, 0, 0, 0.00),
(42, '2015-05-10', 16, 0, 0, 0, 0, 0, 0.00),
(43, '2015-05-10', 17, 0, 0, 0, 0, 0, 0.00),
(44, '2015-05-10', 18, 0, 0, 0, 0, 0, 0.00),
(45, '2015-05-12', 0, 0, 0, 0, 0, 0, 0.00),
(46, '2015-05-12', 1, 0, 0, 0, 0, 0, 0.00),
(47, '2015-05-12', 2, 0, 0, 0, 0, 0, 0.00),
(48, '2015-05-12', 3, 0, 0, 0, 0, 0, 0.00),
(49, '2015-05-12', 4, 0, 0, 0, 0, 0, 0.00),
(50, '2015-05-12', 5, 0, 0, 0, 0, 0, 0.00),
(51, '2015-05-12', 6, 0, 0, 0, 0, 0, 0.00),
(52, '2015-05-12', 7, 0, 0, 0, 0, 0, 0.00),
(53, '2015-05-12', 8, 0, 0, 0, 0, 0, 0.00),
(54, '2015-05-12', 9, 0, 0, 0, 0, 0, 0.00),
(55, '2015-05-12', 10, 0, 0, 0, 0, 0, 0.00),
(56, '2015-05-12', 11, 0, 0, 0, 0, 0, 0.00),
(57, '2015-05-12', 12, 0, 0, 0, 0, 0, 0.00),
(58, '2015-05-12', 13, 0, 0, 0, 0, 0, 0.00),
(59, '2015-05-12', 14, 0, 0, 0, 0, 0, 0.00),
(60, '2015-05-12', 15, 0, 0, 0, 0, 0, 0.00),
(61, '2015-05-12', 16, 0, 0, 0, 0, 0, 0.00),
(62, '2015-05-12', 17, 0, 0, 0, 0, 0, 0.00),
(63, '2015-05-12', 18, 0, 0, 0, 0, 0, 0.00),
(64, '2015-05-12', 19, 0, 0, 0, 0, 0, 0.00),
(65, '2015-05-11', 0, 0, 0, 0, 0, 0, 0.00),
(66, '2015-05-11', 1, 0, 0, 0, 0, 0, 0.00),
(67, '2015-05-11', 2, 0, 0, 0, 0, 0, 0.00),
(68, '2015-05-11', 3, 0, 0, 0, 0, 0, 0.00),
(69, '2015-05-11', 4, 0, 0, 0, 0, 0, 0.00),
(70, '2015-05-11', 5, 0, 0, 0, 0, 0, 0.00),
(71, '2015-05-11', 6, 0, 0, 0, 0, 0, 0.00),
(72, '2015-05-11', 7, 0, 0, 0, 0, 0, 0.00),
(73, '2015-05-11', 8, 0, 0, 0, 0, 0, 0.00),
(74, '2015-05-11', 9, 0, 0, 0, 0, 0, 0.00),
(75, '2015-05-11', 10, 0, 0, 0, 0, 0, 0.00),
(76, '2015-05-11', 11, 0, 0, 0, 0, 0, 0.00),
(77, '2015-05-11', 12, 0, 0, 0, 0, 0, 0.00),
(78, '2015-05-11', 13, 0, 0, 0, 0, 0, 0.00),
(79, '2015-05-11', 14, 0, 0, 0, 0, 0, 0.00),
(80, '2015-05-11', 15, 0, 0, 0, 0, 0, 0.00),
(81, '2015-05-11', 16, 0, 0, 0, 0, 0, 0.00),
(82, '2015-05-11', 17, 0, 0, 0, 0, 0, 0.00),
(83, '2015-05-11', 18, 0, 0, 0, 0, 0, 0.00),
(84, '2015-05-11', 19, 0, 0, 0, 0, 0, 0.00),
(85, '2015-05-11', 20, 0, 0, 0, 0, 0, 0.00),
(86, '2015-05-11', 21, 0, 0, 0, 0, 0, 0.00),
(87, '2015-05-11', 22, 0, 0, 0, 0, 0, 0.00),
(88, '2015-05-11', 23, 0, 0, 0, 0, 0, 0.00),
(89, '2015-05-11', -1, 0, 0, 0, 0, 0, 0.00);
...
(1, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36', 'Chrome', '42.0.2311.135', '', '', 'mac', 2130706433, 1680, 1050, 'http://faycms/a', '', '', '', 'f60d9083f99ae847c41467d11d8cab9d', 1431257932, '2015-05-10', 19, '', 1),
(2, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36', 'Chrome', '42.0.2311.135', '', '', 'mac', 2130706433, 1680, 1050, 'http://faycms/a', '', '', '', '7d2c8ffada69cec27d942496158c3809', 1431433801, '2015-05-12', 20, '', 1);
...
(1, 1, 2130706433, '', 'http://faycms/a', '05DW9z', '', 0, 1431257932, '2015-05-10', 19, 1, 1, '', '', '127.0.0.1'),
(2, 2, 2130706433, '', 'http://faycms/a', '05DW9z', '', 0, 1431433801, '2015-05-12', 20, 1, 1, '', '', '127.0.0.1'),
(3, 2, 2130706433, 'http://faycms/cat/10000', 'http://faycms/', 'vuqeCm', '', 0, 1431436931, '2015-05-12', 21, 1, 1, '', '', '127.0.0.1');
...
(1, '未分类', '_system_post', 0, 0, 1000, '文章分类根目录', 1, 2, 15, 1, '', '', ''),
(2, '页面分类', '_system_page', 0, 0, 1000, '', 1, 16, 17, 1, '', '', ''),
(3, '权限', '_system_action', 0, 0, 1000, '', 1, 18, 57, 1, '', '', ''),
(4, '系统消息', '_system_notification', 0, 0, 1000, '', 1, 58, 59, 1, '', '', ''),
(5, '用户留言', '_system_messages', 0, 0, 1000, '', 1, 60, 61, 1, '', '', ''),
(6, '商品分类', '_system_goods', 0, 0, 1000, '', 1, 62, 63, 1, '', '', ''),
(7, '优惠卷', '_system_voucher', 0, 0, 1000, '', 1, 64, 65, 1, '', '', ''),
(8, '考试', '_system_exam', 0, 0, 1000, '', 1, 66, 71, 1, '', '', ''),
(9, '试题', '_system_exam_question', 8, 0, 1000, '', 1, 67, 68, 1, '', '', ''),
(10, '试卷', '_system_exam_paper', 8, 0, 1000, '', 1, 69, 70, 1, '', '', ''),
(11, '友情链接', '_system_link', 0, 0, 1000, '', 1, 72, 73, 1, '', '', ''),
(101, '友情链接', '_role_youqinglianjie', 3, 0, 1000, '', 1, 19, 20, 1, '', '', ''),
(102, '文件', '_role_wenjian', 3, 0, 1000, '', 1, 21, 22, 1, '', '', ''),
(103, '文章', '_role_wenzhang', 3, 0, 1000, '', 1, 23, 24, 1, '', '', ''),
(104, '提醒', '_role_tixing', 3, 0, 1000, '', 1, 25, 26, 1, '', '', ''),
(105, '用户留言', '_role_yonghuliuyan', 3, 0, 1000, '', 1, 27, 28, 1, '', '', ''),
(106, '管理员', '_role_guanliyuan', 3, 0, 1000, '', 1, 29, 30, 1, '', '', ''),
(107, '页面', '_role_jingtaiyemian', 3, 0, 1000, '', 1, 31, 32, 1, '', '', ''),
(108, '商品', '_role_shangpinguanli', 3, 0, 1000, '', 1, 33, 34, 1, '', '', ''),
(109, '用户', '_role_yonghuguanli', 3, 0, 1000, '', 1, 35, 36, 1, '', '', ''),
(110, '文章评论', '_role_wenzhangpinglun', 3, 0, 1000, '', 1, 37, 38, 1, '', '', ''),
(111, '站点', '_role_zhandian', 3, 0, 1000, '', 1, 39, 40, 1, '', '', ''),
(112, '角色', '_role_juese', 3, 0, 1000, '', 1, 41, 42, 1, '', '', ''),
(113, '访问统计', '_role_fangwentongji', 3, 0, 1000, '', 1, 43, 44, 1, '', '', ''),
(114, '导航栏', '_role_daohanglan', 3, 0, 1000, '', 1, 45, 46, 1, '', '', ''),
(115, '会话', '_role_huihua', 3, 0, 1000, '', 1, 47, 48, 1, '', '', ''),
(116, '试题', '_role_shiti', 3, 0, 1000, '', 1, 49, 50, 1, '', '', ''),
(117, '试卷', '_role_shijuan', 3, 0, 1000, '', 1, 51, 52, 1, '', '', ''),
(118, '模版', '_role_moban', 3, 0, 1000, '', 1, 53, 54, 1, '', '', ''),
(199, '其它（一般不分配）', '_role_qita', 3, 0, 1000, '', 1, 55, 56, 1, '', '', ''),
(10000, '部门职责', 'bumenzhize', 1, 0, 1000, '', 1, 3, 4, 0, '', '', ''),
(10001, '领导分工', 'lingdaofengong', 1, 0, 1000, '', 1, 5, 6, 0, '', '', ''),
(10002, '后勤动态', 'houqindongtai', 1, 0, 1000, '', 1, 7, 8, 0, '', '', ''),
(10003, '文件汇编', 'wenjianhuibian', 1, 0, 1000, '', 1, 9, 10, 0, '', '', ''),
(10004, '下载中心', 'xiazaizhongxin', 1, 0, 1000, '', 1, 11, 12, 0, '', '', ''),
(10005, '科室设置', 'keshishezhi', 1, 0, 1000, '', 1, 13, 14, 0, '', '', '');
...
(1, '绍兴文理学院元培学院', '', 'http://ypc.edu.cn', 1, 10000, '_blank', 1431258070, 1431258070, 100, 0, 0),
(2, 'whis', '', 'http://whis.wang', 1, 10000, '_blank', 1431258124, 1431258124, 100, 0, 0);
...
(1, 0, 1, 'admin:action:login.success', '{"fmac":"","username":"123"}', '2015-05-10', 1431247650, 2130706433, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36'),
(2, 0, 1, 'admin:action:login.success', '{"fmac":"f60d9083f99ae847c41467d11d8cab9d","username":"123"}', '2015-05-10', 1431257933, 2130706433, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36'),
(3, 0, 1, 'admin:action:login.success', '{"fmac":"7d2c8ffada69cec27d942496158c3809","username":"123"}', '2015-05-12', 1431433803, 2130706433, 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/42.0.2311.135 Safari/537.36');
...
(133, 130, 100, 29, 30, '', '文章分类', '', '', 1, 'admin/post/cat', ''),
...
(143, 140, 100, 41, 42, '', '页面分类', '', '', 1, 'admin/page/cat', ''),
...
(160, 100, 100, 52, 57, 'menu', '导航栏', '', 'fa fa-map-marker', 1, 'javascript:;', ''),
(161, 160, 100, 53, 54, '', '自定义导航', '', '', 1, 'admin/menu/index', ''),
(162, 160, 100, 55, 56, '', '后台菜单', '', '', 1, 'admin/menu/admin', ''),
(170, 100, 100, 58, 65, 'link', '友情链接', '', 'fa fa-unlink', 1, 'javascript:;', ''),
(171, 170, 100, 59, 60, '', '所有友链', '', '', 1, 'admin/link/index', ''),
(172, 170, 100, 61, 62, '', '添加友链', '', '', 1, 'admin/link/create', ''),
(173, 170, 100, 63, 64, '', '链接分类', '', '', 1, 'admin/link/cat', ''),
(180, 100, 100, 66, 69, 'cat', '分类', '', 'fa fa-sitemap', 0, 'javascript:;', ''),
(181, 180, 100, 67, 68, '', '所有分类', '', '', 1, 'admin/category/index', ''),
(190, 100, 100, 70, 81, 'site', '站点', '', 'fa fa-cog', 1, 'javascript:;', ''),
(191, 190, 100, 71, 72, '', '站点参数', '', '', 1, 'admin/site/options', ''),
(192, 190, 100, 73, 74, '', '参数列表', '', '', 1, 'admin/option/index', ''),
(193, 190, 100, 75, 76, '', '系统日志', '', '', 1, 'admin/log/index', ''),
(194, 190, 100, 77, 78, '', '小工具', '', '', 1, 'admin/widget/instances', ''),
(195, 190, 100, 79, 80, '', '所有小工具', '', '', 1, 'admin/widget/index', ''),
(200, 100, 100, 82, 93, 'analyst', '访问统计', '', 'fa fa-bar-chart-o', 1, 'javascript:;', ''),
(201, 200, 100, 83, 84, '', '访客统计', '', '', 1, 'admin/analyst/visitor', ''),
(202, 200, 100, 85, 86, '', '访问日志', '', '', 1, 'admin/analyst/views', ''),
(203, 200, 100, 87, 88, '', '页面PV量', '', '', 1, 'admin/analyst/pv', ''),
(204, 200, 100, 89, 90, '', '站点管理', '', '', 1, 'admin/analyst-site/index', ''),
(205, 200, 100, 91, 92, '', '蜘蛛爬行记录', '', '', 1, 'admin/analyst/spiderlog', ''),
(210, 100, 100, 94, 99, 'file', '文件', '', 'fa fa-files-o', 1, 'javascript:;', ''),
(211, 210, 100, 95, 96, '', '所有文件', '', '', 1, 'admin/file/index', ''),
(212, 210, 100, 97, 98, '', '上传文件', '', '', 1, 'admin/file/do-upload', ''),
(220, 100, 100, 100, 105, 'notification', '系统消息', '', 'fa fa-comment', 0, 'javascript:;', ''),
...
(232, 230, 100, 109, 110, '', '模版列表', '', '', 1, 'admin/template/index', ''),
(240, 100, 100, 112, 131, 'exam', '考试系统', '', 'fa fa-graduation-cap', 0, 'javascript:;', ''),
...
(810, 800, 100, 134, 145, 'input', 'Input', '', 'fa fa-download', 1, 'javascript:;', ''),
...
(820, 800, 100, 146, 149, 'css', 'CSS', '', 'fa fa-css3', 1, 'javascript:;', ''),
(821, 820, 100, 147, 148, '', 'compress', '', '', 1, 'tools/css/compress', ''),
(830, 800, 100, 150, 163, 'database', 'Database', '', 'fa fa-database', 1, 'javascript:;', ''),
...
(840, 800, 100, 164, 177, 'function', 'Function', '', 'fa fa-code', 1, 'javascript:;', ''),
...
(850, 800, 100, 178, 181, 'memcache', 'Memcache', '', 'fa fa-inbox', 1, 'javascript:;', ''),
(851, 850, 100, 179, 180, '', 'Records', '', '', 1, 'tools/memcache/index', ''),
(860, 800, 100, 182, 187, 'application', 'Application', '', 'fa fa-codepen', 1, 'javascript:;', ''),
...
(1, 'system.post_review', '0', '是否启用文章审核功能', 1431247614, 1431247614, 1),
(100, 'sitename', '绍兴文理学院元培学院后勤管理服务处', '', 1431247645, 1431433864, 0),
(101, 'copyright', 'Copyright ©2014 whis..', '', 1431433864, 0, 0),
(102, 'beian', '', '', 1431433864, 0, 0),
(103, 'phone', '', '', 1431433864, 0, 0),
(104, 'fax', '', '', 1431433864, 0, 0),
(105, 'email', '', '', 1431433864, 0, 0),
(106, 'address', '', '', 1431433864, 0, 0),
(107, 'seo_index_title', '', '', 1431433864, 0, 0),
(108, 'seo_index_keywords', '', '', 1431433864, 0, 0),
(109, 'seo_index_description', '', '', 1431433864, 0, 0);
...
(10000, '123', '', '', '89840a1e6c2deede3ea5a6fe724c850c', 'z3FEW', '', '', 0, 1431247645, 0, 3, 1431433803, 2130706433, 1431437037, 3, 0, 101, 0, '', 0, '', 0, 0, '', '', '', '');
...
(1, 'friendLinks', '{"title":"\\u53cb\\u60c5\\u94fe\\u63a5","number":5,"cat_id":0,"template":"frontend\\/widget\\/friendLinks"}', 'fay/friendlinks', '友情链接', 1);
...
ALTER TABLE `fay_actions`
  ADD PRIMARY KEY (`id`), ADD KEY `router` (`router`);
...
ALTER TABLE `fay_posts`
  ADD PRIMARY KEY (`id`), ADD KEY `user` (`user_id`), ADD KEY `cat` (`cat_id`);
...
ALTER TABLE `fay_user_notifications`
  ADD PRIMARY KEY (`user_id`,`notification_id`), ADD KEY `unread` (`user_id`,`read`,`deleted`);
...
--
ALTER TABLE `fay_actions`
  MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10000;
--
